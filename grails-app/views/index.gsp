...
<div id="pageBody" class="body">
  ...
  <p>
    ...
    entities. It is very light weight and is deployed as a WAR inside a container like Tomcat.
  </p>
  ...
  <p>
    Get started using the RESTful interface by pointing your app (a browser will do) at <a
      href="${g.resource(dir: 'rest/applyRules')}">${g.resource(dir: 'rest/applyRules')}</a>
  ...
  <p>
    Get started with the SOAP interface by pointing your browser at <a
      href="${g.resource(dir: 'services')}">${g.resource(dir: 'services')}</a> then take in the WSDL.
  </p>
